...
public class UriBuilderTest  extends TestCase {
	...
	public void testRangeQueryBuilder() throws MalformedURLException {
		RangeQueryBuilder rangeQueryBuilder =  QueryBuilderType.RangeQuery.newInstance("http://127.0.0.1:30900");
	...
	public void testInstantQueryBuilder() throws MalformedURLException {
		InstantQueryBuilder iqb = QueryBuilderType.InstantQuery.newInstance("http://127.0.0.1:30900");
	...
	public void testSeriesMetaQueryBuilder() throws MalformedURLException {
		SeriesMetaQueryBuilder smqb = QueryBuilderType.SeriesMetadaQuery.newInstance("http://127.0.0.1:30900");
	...
	public void testLabelMetaQueryBuilder() throws MalformedURLException {
		LabelMetaQueryBuilder lmqb = QueryBuilderType.LabelMetadaQuery.newInstance("http://127.0.0.1:30900");
		URI targetUri = lmqb.withLabel("pod").build();
		System.out.println(targetUri.toURL().toString());
	}
	
	public void testStatusMetaQueryBuilder() throws MalformedURLException {
		StatusMetaQueryBuilder smqb = QueryBuilderType.StatusMetadaQuery.newInstance("http://127.0.0.1:30900");
		URI targetUri = smqb.build();
		System.out.println(targetUri.toURL().toString());
	}
	
	public void testTargetsMetaQueryBuilder() throws MalformedURLException {
		TargetMetaQueryBuilder tmqb = QueryBuilderType.TargetMetadaQuery.newInstance("http://127.0.0.1:30900");
		URI targetUri = tmqb.build();
		System.out.println(targetUri.toURL().toString());
	}
	
	public void testAlertManagerMetaQueryBuilder() throws MalformedURLException {
		AlertManagerMetaQueryBuilder ammqb = QueryBuilderType.AlertManagerMetadaQuery.newInstance("http://127.0.0.1:30900");
